...
kotlin {
    ...
    val xcf = XCFramework("TracingTest")

    macosArm64 {
        binaries.framework { baseName = "TracingTest"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TracingTest"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TracingTest"
        flattenPackage = "io.github.kotlinmania.tracingtest"
    }

    android {
        namespace = "io.github.kotlinmania.tracingtest"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tracing-test-kotlin", version.toString())

    pom {
        name.set("tracing-test-kotlin")
        description.set("Kotlin Multiplatform port of dbrgn/tracing-tes - Helper functions and macros that allow for easier testing of crates that use `tracing`")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tracing-test-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tracing-test-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tracing-test-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tracing-test-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTracingTestXCFramework",
    "assembleTracingTestDebugXCFramework",
    "assembleTracingTestReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTracingTestXCFramework",
    "assembleReleaseIosFatFrameworkForTracingTestXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTracingTestXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTracingTestXCFramework",
    "assembleDebugMacosFatFrameworkForTracingTestXCFramework",
    "assembleReleaseMacosFatFrameworkForTracingTestXCFramework",
    "assembleDebugTvosFatFrameworkForTracingTestXCFramework",
    "assembleReleaseTvosFatFrameworkForTracingTestXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTracingTestXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTracingTestXCFramework",
    "assembleDebugWatchosFatFrameworkForTracingTestXCFramework",
    "assembleReleaseWatchosFatFrameworkForTracingTestXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTracingTestXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTracingTestXCFramework",
