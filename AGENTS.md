...
This file is the quick-reference operating contract for tracing-test-kotlin. The longer
...
tracing-test-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tracing-test`](https://crates.io/crates/tracing-test). Upstream Rust is the behavioral oracle while the
